    ...
    render() {
        return (
            <p class="break-words" style={{fontSize: 20}}>
                This artist's creation comes from the deepest emotion. His voice sings the brilliance of the soul. He
                regards music and dreams as energy, and he has reached an unreplaceable position all the way. He wrote
                the most moving classic movement in the Chinese music scene, shaking dozens of people in Asia.
            </p>
        );
    }
}
...
class ArtistIntroduction2 extends Component {
    render() {
        return (
            <p class="break-words" style={{fontSize: 20}}>
                Born in New Taipei City, Taiwan Province on January 18, 1979, is a native of YongchunCounty, Quanzhou
                City, Fujian Province. He is a Taiwanese pop singer, original musician, actor, director, and
                screenwriter.
            </p>
        );
    }
    ...
    render() {
        return (
            <p class="break-words" style={{fontSize: 20}}>
                ...
                producer in Mainland China. He graduated from Glion Hotel Management College.
            </p>
        );
    }
}
